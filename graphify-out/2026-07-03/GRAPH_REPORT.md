...
## Corpus Check
- 62 files · ~32,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 607 nodes · 1100 edges · 41 communities (32 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5b9691d`
...
Cohesion: 0.24
Nodes (7): MixerAdapter, PressAdapter, S7TagConfig, Adapter, AdapterMeta, TagMeta, TagUpdate
...
Cohesion: 0.06
Nodes (26): Deps, Hud, alarmsPanel, bindingEngine, bindingPanel, bindingsPanel, canvas, conn (+18 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (18): ControlPanelDef, widgetAcceptsTag(), WidgetType, ControlPanels, WIDGET_TYPES, createPanel(), newBindingId(), TagValue (+10 more)
...
Cohesion: 0.16
Nodes (14): ConveyorAdapterConfig, MixerAdapterConfig, PressAdapterConfig, S7AdapterConfig, BusListener, AdapterConfigEntry, CONFIG_URL, GatewayConfig (+6 more)
...
Cohesion: 0.06
Nodes (23): alarmActive(), AlarmsPanel, formatDuration(), ConnectionsPanel, RefreshState, Deps, HelloMessage, Panel (+15 more)

### Community 31 - "Community 31"
Cohesion: 0.11
Nodes (8): AlarmRule, Project, Widget, download(), FileMenu, slugify(), DEFAULT_PROJECT, ProjectStore
...
Cohesion: 0.20
Nodes (9): ClientMessage, GatewayMessage, RefreshTagsMessage, TagsChangedMessage, TagsRefreshErrorMessage, TagUpdateMessage, WriteErrorMessage, WriteMessage (+1 more)

## Knowledge Gaps
- **211 isolated node(s):** `node`, `name`, `version`, `type`, `main` (+206 more)
...
- **Why does `TagMeta` connect `Community 1` to `Community 0`, `Community 33`, `Community 34`, `Community 35`, `Community 4`, `Community 37`, `Community 38`, `Community 7`, `Community 40`, `Community 39`, `Community 3`, `Community 13`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `TagStore` connect `Community 30` to `Community 1`, `Community 2`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `AdapterMeta` connect `Community 1` to `Community 0`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 7`, `Community 40`, `Community 39`, `Community 13`, `Community 28`, `Community 30`?**
