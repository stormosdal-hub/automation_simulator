...
## Corpus Check
- 64 files · ~35,190 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 634 nodes · 1165 edges · 47 communities (34 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cbccf805`
...
5. `PublishFn` - 25 edges
6. `TagBus` - 25 edges
7. `TagUpdate` - 25 edges
8. `Adapter` - 24 edges
9. `ModbusAdapter` - 18 edges
10. `TiaWebAdapter` - 18 edges
...
Cohesion: 0.10
Nodes (23): ConveyorAdapterConfig, MixerAdapterConfig, ModbusAdapterConfig, ModbusTagConfig, coerce(), MqttAdapterConfig, MqttTagConfig, walkPath() (+15 more)

### Community 1 - "Community 1"
Cohesion: 0.22
Nodes (8): MixerAdapter, PressAdapter, S7TagConfig, Adapter, PublishFn, BusListener, AdapterMeta, TagUpdate
...
Cohesion: 0.12
Nodes (16): alarmsPanel, bindingEngine, bindingPanel, bindingsPanel, canvas, conn, connectionsPanel, hud (+8 more)
...
Cohesion: 0.25
Nodes (9): Panel, RecordedEvent, Recording, button(), div(), formRow(), numberInput(), select() (+1 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (29): AlarmCondition, AlarmRule, ControlPanelDef, Project, ThresholdStop, Widget, widgetAcceptsTag(), WidgetConfig (+21 more)
...
Cohesion: 0.16
Nodes (6): DiscoveredTag, discoverTags(), TiaState, TiaWebAdapter, TiaWebTagConfig, TagMeta
...
Cohesion: 0.12
Nodes (13): ConnectTiaMessage, HelloMessage, RefreshTagsMessage, TagsChangedMessage, TagsRefreshErrorMessage, TagUpdateMessage, TestTiaMessage, TiaConnectedMessage (+5 more)

### Community 41 - "Community 41"
Cohesion: 0.18
Nodes (9): RefreshState, Deps, Hud, ClientMessage, GatewayMessage, connectGateway(), GatewayConnection, STRUCTURAL_TYPES (+1 more)

### Community 43 - "Community 43"
Cohesion: 0.19
Nodes (3): TagRow, TagStore, TagTable
...
## Knowledge Gaps
- **221 isolated node(s):** `node`, `name`, `version`, `type`, `main` (+216 more)
...
- **Why does `AdapterMeta` connect `Community 1` to `Community 0`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 7`, `Community 40`, `Community 39`, `Community 41`, `Community 43`, `Community 13`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `TagStore` connect `Community 43` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 34`, `Community 40`, `Community 41`, `Community 42`, `Community 44`, `Community 45`, `Community 46`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `TagMeta` connect `Community 34` to `Community 0`, `Community 1`, `Community 33`, `Community 35`, `Community 37`, `Community 38`, `Community 7`, `Community 40`, `Community 39`, `Community 41`, `Community 43`, `Community 13`, `Community 31`?**
